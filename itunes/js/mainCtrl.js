...
app.controller('mainCtrl', function($scope, itunesService){
  ...
  //this means when you make your iTunes request, you'll need to get back the information, parse 
  //it accordingly, then set it to songData on the scope -> $scope.songData = ...
  $scope.gridOptions = { 
      data: 'songData',
      height: '110px',
